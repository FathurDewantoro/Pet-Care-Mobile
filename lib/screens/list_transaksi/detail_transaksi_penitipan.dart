...
class DetailTransaksiPenitipan extends StatefulWidget {
  List<ModelTransaksiPenitipan> dataTransaksi = [];
  DetailTransaksiPenitipan({super.key, required this.dataTransaksi});

  @override
  State<DetailTransaksiPenitipan> createState() =>
      _DetailTransaksiPenitipanState();
}

class _DetailTransaksiPenitipanState extends State<DetailTransaksiPenitipan> {
  ...
  void batalTransaksi() async {
    ...
    try {
      var response = await http.post(
        Uri.parse(apiUrl + "/api/batalTransaksiPenitipan"),
        ...
        body: jsonEncode(<String, String>{
          'id_transaksi': widget.dataTransaksi.first.id,
          'id_penitipan': widget.dataTransaksi.first.idPenitipan.toString(),
        }),
      );
  ...
  late bool statusPembayaran =
      widget.dataTransaksi.first.statusPembayaran == 'Lunas' ||
              widget.dataTransaksi.first.metodePembayaran == 'Tunai'
          ? false
          : true;
  late bool tomboBatal =
      widget.dataTransaksi.first.statusPembayaran == 'Lunas' ? false : true;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text(
                            widget.dataTransaksi.first.infoPenitipan
                                .namaPenitipan,
                            style: TextStyle(
                        ...
                        SizedBox(
                          ...
                          child: Text(
                            DateFormat('EEE, dd MMM yyyy').format(
                                widget.dataTransaksi.first.tanggalTitip),
                            style: TextStyle(
                                fontWeight: FontWeight.w700, fontSize: 14),
                            textAlign: TextAlign.start,
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text(
                              DateFormat('EEE, dd MMM yyyy').format(
                                  widget.dataTransaksi.first.tanggalAmbil),
                              style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: displayWidth(context) * 0.34,
                          child: Text(
                            widget.dataTransaksi.first.statusPembayaran,
                            style: TextStyle(
                                fontWeight: FontWeight.w700, fontSize: 15),
                          ),
                        )
