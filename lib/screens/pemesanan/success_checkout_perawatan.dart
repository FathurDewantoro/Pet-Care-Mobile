...
class SuccessCheckoutPerawatan extends StatefulWidget {
  List<ModelSingleTransaksiPerawatan> dataTransaksi = [];
  SuccessCheckoutPerawatan({super.key, required this.dataTransaksi});

  @override
  State<SuccessCheckoutPerawatan> createState() =>
      _SuccessCheckoutPerawatanState();
}

class _SuccessCheckoutPerawatanState extends State<SuccessCheckoutPerawatan> {
  @override
              ...
              children: [
                ...
                Text(
                  CurrencyFormat.convertToIdr(
                      widget.dataTransaksi.first.total, 0),
                  style: TextStyle(
                      color: Colors.black,
                      ...
                      SizedBox(
                        ...
                        child: Text(
                          DateFormat('EEE, dd MMM yyyy').format(DateTime.parse(
                              widget.dataTransaksi.first.tanggalPerawatan)),
                          style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Text(
                          widget.dataTransaksi.first.status,
                          style: TextStyle(
                              fontWeight: FontWeight.w700, fontSize: 15),
                          textAlign: TextAlign.end,
                        ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Text(
                          widget
                              .dataTransaksi.first.infoPerawatan.namaPerawatan,
                          style: TextStyle(
                              fontWeight: FontWeight.w700, fontSize: 14),
                          textAlign: TextAlign.end,
                        ),
